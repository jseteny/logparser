...
class LogParserSpec extends Specification {
  ...
  "        [java] 15:13:29, INFO,  , d.c.o.d.internal.DBAssistent - Processing global schema 'globalschema'." should {
    """be parsed as Log4JLine("java", "15:13:29", "INFO", ", d.c.o.d.internal.DBAssistent - Processing global schema 'globalschema'.")""" in {
      ...
      result must be_===(
        LogLine("java", "15:13:29", "INFO", ", d.c.o.d.internal.DBAssistent - Processing global schema 'globalschema'.")
      )
    }
  }
  ...
  "        [java] org.springframework.jdbc.CannotGetJdbcConnectionException: Could not get JDBC Connection; nested exception is com.mysql.jdbc.exceptions.jdbc4.MySQLNonTransientConnectionException: Could not create connection to database server. Attempted reconnect 3 times. Giving up." should {
    """be parsed as ExceptionLine("java", "org.springframework.jdbc.CannotGetJdbcConnectionException", "Could not get JDBC Connection; nested exception is com.mysql.jdbc.exceptions.jdbc4.MySQLNonTransientConnectionException: Could not create connection to database server. Attempted reconnect 3 times. Giving up.")""" in {
